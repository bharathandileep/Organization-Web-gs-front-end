...
const tasks: TaskTypes[] = [
  ...
  {
    id: 3,
    title: "DineEase v2.1 - Angular and Django",
  ...
  {
    id: 4,
    title: "DineEase v2.1 - React, Webpack",
    description:
  ...
  {
    id: 5,
    title: "DineEase 2.2 - Vue.Js and Laravel",
    description:
      "There are many variations of passages of Lorem Ipsum available.",
    status: "Upcoming",
    priority: "Low",
  ...
  {
    id: 6,
    title: "DineEase 2.3 - Rails, NodeJs, Mean",
    description:
  ...
  {
    id: 7,
    title: "DineEase - Landing page and UI Kit",
