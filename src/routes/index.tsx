...
// - Associate
const Associate = React.lazy(() => import("../pages/apps/Restaurants"));
const CompanyDetail = React.lazy(() => import("../pages/apps/Restaurants/Detail"));
//  - Employee
const Employee = React.lazy(() => import("../pages/apps/Employee"));
// -employee user details
const UserDetails = React.lazy(() => import("../pages/apps/Employee/Profile"));
// food orders
const FoodOrders = React.lazy(() => import("../pages/apps/Orders/Orders"));

// - Food
const FoodDetails = React.lazy(() => import("../pages/apps/FoodAndOrders/Products"));
const CartDetails = React.lazy(() => import("../pages/apps/FoodAndOrders/Cart"));
const CheckoutDetails = React.lazy(() => import("../pages/apps/FoodAndOrders/Checkout"));
const OrderDetailsFood = React.lazy(() => import("../pages/apps/FoodAndOrders/OrderDetails"));
// settings
...
const foodOrderAppRoute ={
  path: "/apps/food/history",
  name: "order",
  route: PrivateRoute,
  roles: ["Admin"],
  icon: "users",
  element: <OrderDetailsFood />,
};
